...
function SayGreeting3(name, age) {
    if (age) {
...
function SayGreeting4(name, age = 0) {
    return `Hello, ${name}. Your age: ${age}.`;
}
console.info("Simple function, takes a string and an optional number, returns a string...");
...
function SayGreeting5(name, age, ...nicknames) {
    let nicknamesCsv = "";
...
function SayGreeting6(name, age) {
    if (age) {
        return `Hello, ${name}. Your age: ${age}.`;
    }
    else {
...
// Function Types
// ==============
function SayGreeting7(name, age) {
